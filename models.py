...
class Parameter(db.Model):
    ...
    user_id = db.Column(db.Integer, db.ForeignKey('users.id'), nullable=False)
    name = db.Column(db.String(100), nullable=False)
    parameter_type = db.Column(db.String(20), default='scale')  # scale, binary, text
    ...
    values = db.relationship('ParameterValue', backref='parameter', lazy='dynamic', cascade='all, delete-orphan')
