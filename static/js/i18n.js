...
'btn.signin': 'Sign In',
        ...
        'onboarding.diary_desc': 'The Diary is where you record your daily wellness: Mood, Energy, Sleep Quality, Physical Activity, and Stress levels. Select a date on the calendar, set your values using the sliders, and save.',
        ...
        'onboarding.progress_desc': 'The Progress page shows your wellness data as visual charts and graphs. Track how your mood, sleep, and energy change over time. Set your location to see local time and weather context.',
        ...
        'onboarding.circles_desc': 'Circles let you organize your connections into trust levels: General (acquaintances), Close Friends, and Family. Each circle controls who can see specific diary entries and updates you share.',
        'onboarding.circles_tip': 'Tip: When posting in your feed or saving diary entries, you can choose which circle can see them.',
        ...
        'onboarding.connections_desc': 'Find and follow other users in the Connections tab. Browse recommendations, search for people, and manage your connections. Click any connection to view their profile, send a message, or set up alerts.',
        ...
        'onboarding.invite_desc': 'Share your unique invite link with friends, family, or your therapist. When they join, they\'ll be prompted to connect with you. Growing your circle makes TheraSocial more meaningful.',
        'onboarding.invite_tip': 'Tip: Your invite link can be shared via text, email, or social media.',
        'onboarding.triggers': 'Triggers & Alerts — Watch Over Loved Ones',
        'onboarding.triggers_desc': 'Set wellness alerts for connections you care about. When you view someone\'s profile, use the Triggers button to define thresholds — for example, get notified if their mood drops below 2 or stress rises above 4.',
        'onboarding.triggers_tip': 'Tip: Alerts are a caring tool. You\'ll receive email notifications when patterns are detected.',
        'onboarding.settings': 'Settings — Personalize Your Experience',
        'onboarding.settings_desc': 'In Settings, manage your profile (bio, interests, goals), change your password, set notification preferences, choose your diary reminder time, and export your data. You can also toggle dark mode for evening use.',
        'onboarding.settings_tip': 'Tip: Set a daily diary reminder to build a consistent tracking habit.',
        'onboarding.finish_title': 'You\'re All Set!',
        'onboarding.finish_desc': 'You now know everything you need to start your TheraSocial wellness journey. Start by updating your diary, connecting with friends, and checking in daily.',
...
'menu.social': 'Social',
    ...
    he: {
        ...
        'onboarding.diary_desc': 'ביומן תתעדו את הבריאות היומית: מצב רוח, אנרגיה, איכות שינה, פעילות גופנית ורמות לחץ. בחרו תאריך בלוח השנה, הגדירו את הערכים באמצעות המחוונים ושמרו.',
        ...
        'onboarding.progress_desc': 'דף ההתקדמות מציג את נתוני הבריאות שלכם כגרפים ותרשימים חזותיים. עקבו אחר שינויים במצב רוח, שינה ואנרגיה לאורך זמן. הגדירו מיקום לצפייה בשעה ומזג אוויר מקומי.',
        ...
        'onboarding.circles_desc': 'מעגלים מאפשרים לארגן את הקשרים לרמות אמון: כללי (מכרים), חברים קרובים ומשפחה. כל מעגל קובע מי יכול לראות רשומות יומן ועדכונים ספציפיים שאתם משתפים.',
        'onboarding.circles_tip': 'טיפ: כשאתם מפרסמים בפיד או שומרים רשומות יומן, תוכלו לבחור איזה מעגל יוכל לראות אותם.',
        ...
        'onboarding.connections_desc': 'מצאו ועקבו אחר משתמשים אחרים בלשונית קשרים. דפדפו בהמלצות, חפשו אנשים ונהלו את הקשרים שלכם. לחצו על כל קשר כדי לצפות בפרופיל, לשלוח הודעה או להגדיר התראות.',
        ...
        'onboarding.invite_desc': 'שתפו את קישור ההזמנה הייחודי שלכם עם חברים, משפחה או המטפל שלכם. כשהם מצטרפים, הם יתבקשו להתחבר אליכם. הרחבת המעגל הופכת את TheraSocial למשמעותי יותר.',
        'onboarding.invite_tip': 'טיפ: ניתן לשתף את קישור ההזמנה בהודעת טקסט, אימייל או רשתות חברתיות.',
        'onboarding.triggers': 'טריגרים והתראות — שמרו על יקיריכם',
        'onboarding.triggers_desc': 'הגדירו התראות בריאות לקשרים שאכפת לכם מהם. כשאתם צופים בפרופיל של מישהו, השתמשו בכפתור הטריגרים להגדרת סף — למשל, קבלו התראה אם מצב הרוח שלהם יורד מתחת ל-2 או הלחץ עולה מעל 4.',
        'onboarding.triggers_tip': 'טיפ: התראות הן כלי של אכפתיות. תקבלו התראות במייל כשזוהו דפוסים.',
        'onboarding.settings': 'הגדרות — התאימו את החוויה שלכם',
        'onboarding.settings_desc': 'בהגדרות, נהלו את הפרופיל (ביוגרפיה, תחומי עניין, מטרות), שנו סיסמה, הגדירו העדפות התראות, בחרו שעת תזכורת יומן וייצאו נתונים. ניתן גם להפעיל מצב כהה לשימוש בערב.',
        'onboarding.settings_tip': 'טיפ: הגדירו תזכורת יומן יומית כדי לבנות הרגל מעקב עקבי.',
...
'privacy.private': 'פרטי',
    ...
    ar: {
        ...
        'onboarding.home_tip': 'نصيحة: استخدم تسجيل الدخول السريع لتسجيل مزاجك بنقرة واحدة — حتى في الأيام المزدحمة.',
        'onboarding.diary': 'اليوميات — تتبع عافيتك',
        'onboarding.diary_desc': 'اليوميات هي المكان الذي تسجل فيه عافيتك اليومية: المزاج، الطاقة، جودة النوم، النشاط البدني، ومستويات التوتر. اختر تاريخاً من التقويم، اضبط القيم باستخدام المنزلقات، واحفظ.',
        'onboarding.diary_tip': 'نصيحة: الاستمرارية هي المفتاح! حتى تسجيل سريع لمدة 30 ثانية يساعد في بناء أنماط ذات معنى مع الوقت.',
        'onboarding.progress': 'التقدم — شاهد اتجاهاتك',
        'onboarding.progress_desc': 'تعرض صفحة التقدم بيانات عافيتك كرسوم بيانية مرئية. تتبع كيف يتغير مزاجك ونومك وطاقتك مع الوقت. حدد موقعك لرؤية الوقت المحلي وسياق الطقس.',
        ...
        'onboarding.circles_desc': 'تتيح لك الدوائر تنظيم اتصالاتك حسب مستويات الثقة: عام (معارف)، أصدقاء مقربون، وعائلة. كل دائرة تتحكم في من يمكنه رؤية إدخالات يوميات وتحديثات محددة تشاركها.',
        'onboarding.circles_tip': 'نصيحة: عند النشر في يومياتك أو حفظ إدخالات، يمكنك اختيار أي دائرة يمكنها رؤيتها.',
        'onboarding.messages': 'الرسائل — محادثات خاصة',
        'onboarding.messages_desc': 'أرسل رسائل خاصة إلى أي من اتصالاتك. استخدم زر القوالب 💬 لرسائل دعم سريعة عندما لا تكون متأكداً ماذا تقول.',
        ...
        'onboarding.connections_desc': 'ابحث عن مستخدمين آخرين وتابعهم في تبويب الاتصالات. تصفح التوصيات، ابحث عن أشخاص، وأدر اتصالاتك. انقر على أي اتصال لعرض ملفه الشخصي أو إرسال رسالة أو إعداد تنبيهات.',
        'onboarding.connections_tip': 'نصيحة: تابع الأشخاص الذين تثق بهم لرؤية تحديثات عافيتهم ودعم بعضكم البعض.',
        'onboarding.invite': 'الدعوة — اجلب أصدقاءك',
        'onboarding.invite_desc': 'شارك رابط الدعوة الفريد الخاص بك مع الأصدقاء أو العائلة أو معالجك. عندما ينضمون، سيُطلب منهم التواصل معك. توسيع دائرتك يجعل TheraSocial أكثر معنى.',
        'onboarding.invite_tip': 'نصيحة: يمكن مشاركة رابط الدعوة عبر الرسائل النصية أو البريد الإلكتروني أو وسائل التواصل الاجتماعي.',
        'onboarding.triggers': 'المحفزات والتنبيهات — اعتنِ بأحبائك',
        'onboarding.triggers_desc': 'عيّن تنبيهات عافية للاتصالات التي تهتم بها. عند عرض ملف شخص ما، استخدم زر المحفزات لتحديد عتبات — مثلاً، احصل على إشعار إذا انخفض مزاجهم عن 2 أو ارتفع توترهم فوق 4.',
        'onboarding.triggers_tip': 'نصيحة: التنبيهات أداة رعاية. ستتلقى إشعارات بالبريد الإلكتروني عند اكتشاف أنماط.',
        'onboarding.settings': 'الإعدادات — خصص تجربتك',
        'onboarding.settings_desc': 'في الإعدادات، أدر ملفك الشخصي (السيرة، الاهتمامات، الأهداف)، غيّر كلمة المرور، اضبط تفضيلات الإشعارات، اختر وقت تذكير اليوميات، وصدّر بياناتك. يمكنك أيضاً تفعيل الوضع الداكن للاستخدام المسائي.',
        'onboarding.settings_tip': 'نصيحة: عيّن تذكيراً يومياً لليوميات لبناء عادة تتبع منتظمة.',
        'onboarding.finish_title': '!أنت جاهز',
        'onboarding.finish_desc': 'أنت الآن تعرف كل ما تحتاجه لبدء رحلة العافية في TheraSocial. ابدأ بتحديث يومياتك، والتواصل مع الأصدقاء، وتسجيل الدخول يومياً.',
        'onboarding.finish_tip': 'تذكر: الخطوات الصغيرة والمنتظمة تقود إلى تغيير ذي معنى. نحن هنا لدعمك في كل خطوة.',
...
'day.saturday': 'السبت',
    ...
    ru: {
        ...
        'onboarding.welcome_desc': 'Ваш помощник для отслеживания здоровья, общения и совместного роста. Это краткое руководство расскажет вам обо всём, что нужно знать.',
        ...
        'onboarding.home_desc': 'Главная страница показывает всё сразу: сегодняшнее состояние здоровья, вашу серию дней, быструю отметку настроения, персональные рекомендации, обновления друзей и ленту дневника.',
        ...
        'onboarding.diary_desc': 'Дневник — это место для записи ежедневного состояния: настроение, энергия, качество сна, физическая активность и уровень стресса. Выберите дату в календаре, установите значения ползунками и сохраните.',
        'onboarding.diary_tip': 'Совет: Главное — регулярность! Даже быстрая отметка за 30 секунд помогает выявить значимые закономерности со временем.',
        'onboarding.progress': 'Прогресс — Смотрите тенденции',
        'onboarding.progress_desc': 'Страница прогресса показывает данные о здоровье в виде графиков и диаграмм. Отслеживайте изменения настроения, сна и энергии. Укажите местоположение для отображения местного времени и погоды.',
        'onboarding.progress_tip': 'Совет: Ищите закономерности — например, как физические упражнения влияют на настроение на следующий день.',
        'onboarding.circles': 'Круги — Уровни приватности',
        'onboarding.circles_desc': 'Круги позволяют распределить контакты по уровням доверия: Общий (знакомые), Близкие друзья и Семья. Каждый круг определяет, кто может видеть конкретные записи дневника и обновления.',
        'onboarding.circles_tip': 'Совет: При публикации в ленте или сохранении записей дневника вы можете выбрать, какой круг их увидит.',
        'onboarding.messages': 'Сообщения — Личные беседы',
        'onboarding.messages_desc': 'Отправляйте личные сообщения любому из ваших контактов. Используйте кнопку шаблонов 💬 для быстрых сообщений поддержки, когда не знаете, что написать.',
        'onboarding.messages_tip': 'Совет: Короткое ободряющее сообщение может украсить чей-то день — не раздумывайте долго!',
        'onboarding.connections': 'Контакты — Создайте свою сеть',
        'onboarding.connections_desc': 'Находите и подписывайтесь на других пользователей во вкладке «Контакты». Просматривайте рекомендации, ищите людей и управляйте связями. Нажмите на любой контакт, чтобы просмотреть профиль, отправить сообщение или настроить оповещения.',
        'onboarding.connections_tip': 'Совет: Подписывайтесь на людей, которым доверяете, чтобы видеть обновления их состояния и поддерживать друг друга.',
        'onboarding.invite': 'Приглашение — Позовите друзей',
        'onboarding.invite_desc': 'Поделитесь уникальной ссылкой-приглашением с друзьями, семьёй или терапевтом. Когда они присоединятся, им предложат связаться с вами. Расширение круга делает TheraSocial более значимым.',
        'onboarding.invite_tip': 'Совет: Ссылку-приглашение можно отправить через SMS, email или социальные сети.',
        'onboarding.triggers': 'Триггеры и оповещения — Следите за близкими',
        'onboarding.triggers_desc': 'Настройте оповещения о здоровье для контактов, о которых заботитесь. При просмотре чьего-то профиля используйте кнопку «Триггеры» для установки порогов — например, получайте уведомление, если настроение опускается ниже 2 или стресс поднимается выше 4.',
        'onboarding.triggers_tip': 'Совет: Оповещения — это инструмент заботы. Вы получите уведомления по email при обнаружении закономерностей.',
        'onboarding.settings': 'Настройки — Персонализируйте опыт',
        'onboarding.settings_desc': 'В настройках управляйте профилем (биография, интересы, цели), меняйте пароль, настраивайте уведомления, выбирайте время напоминания дневника и экспортируйте данные. Также можно включить тёмную тему для вечернего использования.',
        'onboarding.settings_tip': 'Совет: Установите ежедневное напоминание дневника, чтобы выработать привычку регулярного отслеживания.',
        'onboarding.finish_title': 'Всё готово!',
        'onboarding.finish_desc': 'Теперь вы знаете всё необходимое для начала пути к здоровью с TheraSocial. Начните с обновления дневника, подключения друзей и ежедневных отметок.',
        'onboarding.finish_tip': 'Помните: маленькие, постоянные шаги ведут к значимым переменам. Мы здесь, чтобы поддерживать вас на каждом этапе.',
