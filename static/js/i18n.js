...
'invite.legacy_alert_content': 'دعاك شخص ما لمتابعته',
  ...
  'support.title': 'مركز الدعم',
    ...
    'about.privacy_desc': 'تركز المنصة على قدرات المحادثة الخاصة بين المستخدمين، مع إعطاء الأولوية للخصوصية والسلامة.',
...
'invite.send_request': 'Отправить запрос',
   ...
   'about.privacy_desc': 'Платформа подчеркивает возможности приватных чатов между пользователями, отдавая приоритет анонимности и безопасности.',
